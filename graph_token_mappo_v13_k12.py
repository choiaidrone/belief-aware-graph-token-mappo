...
K_ACTIVE   = 12      # K-slot sensitivity variant (base=12, same as main setting)
N_ZONE     = 16
N_GLOBAL   = 1

NUM_DRONES   = N_DRONE_TRAIN
# K-slot sensitivity: OBS_DIM = 300+8+2+100+K*6+2
# K=12 → DS(300)+depth(8)+self(2)+fused_priority(100)+active(72)+battery(2) = 484
OBS_DIM      = 484
ACTION_DIM   = 4
DS_N_RL      = 10
MAP_W        = 100.0
...
OBS_BATTERY_START   = 482           # K*6=72dim active 다음 (410+72)
